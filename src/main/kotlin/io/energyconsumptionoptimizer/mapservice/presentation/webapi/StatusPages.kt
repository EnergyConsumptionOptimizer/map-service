...
import io.energyconsumptionoptimizer.mapservice.presentation.webapi.errors.EmptyUpdateRequestException
...
fun Application.configureStatusPages() {
    install(StatusPages) {
        exception<ZoneNameAlreadyExistsException> { call, _ ->
            call.respond(
        ...
        exception<SmartFurnitureHookupAlreadyExistsException> { call, _ ->
            call.respond(
                HttpStatusCode.Conflict,
                ApiErrorResponse(
                    code = "CONFLICT",
